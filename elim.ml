...
let rec eliminatable (r, e) = 
  match e with
  | Unit | Var _ | App _ | Get _ | Put _ | ExtFunApp _ | ExtArray _ | ExtTuple _ -> false
  | Int _ | Float _ | Neg _ | Add _ | Sub _ | Lsl _ | Lsr _ | FNeg _ | FAdd _ | FSub _ | FMul _ | FDiv _ | Tuple _ -> true
  | IfEq(_, _, e1, e2) | IfLE(_, _, e1, e2) | Let(_, e1, e2) -> eliminatable e1 && eliminatable e2
  | LetRec(_, e) | LetTuple(_, _, e) -> eliminatable e
